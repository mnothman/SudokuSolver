...
def train_sudoku_model(csv_path, model_save_path, max_samples=50000):
    quizzes, solutions = load_sudoku_data(csv_path)

    quizzes = quizzes[:max_samples]
    solutions = solutions[:max_samples]
    
    quizzes_normalized, solutions_one_hot = preprocess_data(quizzes, solutions)
...
if __name__ == "__main__":
    train_sudoku_model("data/datasetTraining/sudoku_training/sudoku.csv", "models/sudoku_solver.keras", max_samples=50000)
